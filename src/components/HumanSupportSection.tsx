      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className={`text-xl sm:text-2xl text-hubcsr-blue font-semibold mb-6 sm:mb-8 transition-all duration-700 ${
              isInView ? 'animate-fade-in-delay-1' : 'opacity-0 translate-y-8'
            }`}>
              Você não fica sozinho.
            </p>
            <p className={`text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto transition-all duration-700 ${
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
            ...
            <div className="flex-1 space-y-6 sm:space-y-8 w-full">
              <div className="space-y-4 sm:space-y-6">
                <div className={`flex items-start gap-3 sm:gap-4 p-4 sm:p-6 bg-white rounded-xl shadow-card border border-hubcsr-blue/20 hover:shadow-lg transition-all duration-300 ${
                  ...
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-gray-600">Time experiente em gestão de ONGs e captação de recursos.</p>
                  </div>
                </div>
                ...
                <div className={`flex items-start gap-3 sm:gap-4 p-4 sm:p-6 bg-white rounded-xl shadow-card border border-hubcsr-blue/20 hover:shadow-lg transition-all duration-300 ${
                  ...
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-gray-600">Resposta em até 2 horas durante dias úteis.</p>
                  </div>
                </div>
                ...
                <div className={`flex items-start gap-3 sm:gap-4 p-4 sm:p-6 bg-white rounded-xl shadow-card border border-hubcsr-blue/20 hover:shadow-lg transition-all duration-300 ${
                  ...
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-gray-600">Cada OSC tem um plano específico baseado em suas necessidades.</p>
                  </div>
                </div>
              </div>
            </div>
