...
const InvestmentSectionV2 = () => {
  ...
  return (
    <section ref={ref} id="investimento" className="py-16 sm:py-20 lg:py-24 bg-primary/5">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            ...
            {/* New Way */}
            <div className={`bg-primary/10 border-2 border-primary/30 rounded-2xl p-8 transition-all duration-700 ${
          ...
          <div className={`text-center transition-all duration-700 ${
            ...
            <div className="bg-card border border-border rounded-2xl p-8 sm:p-12 shadow-lg mb-8">
              <h3 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">
                Por apenas <span className="text-primary">R$ 350/mês</span>, sua organização tem tudo.
              </h3>
